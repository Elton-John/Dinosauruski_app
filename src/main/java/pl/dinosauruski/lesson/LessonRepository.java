...
public interface LessonRepository extends JpaRepository<Lesson, Long> {
    ...
    @Query("SELECT new pl.dinosauruski.lesson.dto.LessonDTO(l.id,l.date, l.slot, l.student, l.week) FROM Lesson l WHERE l.id = :id")
    ...
    @Query("SELECT l FROM Lesson l WHERE l.slot=:slot AND l.student = :student AND l.date > :today")
    List<Lesson> AllLessonsBySlotAndStudentInFuture(@Param("slot")Slot slot,
